...
const Search = ({ name, price, description, img }) => {
  return (
    <Link href={"#"}>
       <div className="w-[45%] bg-[#F0F5FA]  mb-5 h-[190px] ml-3 rounded-lg md:w-[2]">
      <div className="flex mt-4 ml-3 w-full ">
        <Image className="" src={img} width={50} height={50} alt="img-platano" />
      ...
      <div className="flex mt-3 ml-3  ">
        ...
        <Link href={"#"}>
          <img src="/shopping-cart.svg" alt="img-shopping" />
        </Link>
      </div>
    </div>
