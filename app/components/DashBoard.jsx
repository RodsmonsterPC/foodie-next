        ...
        >
          <div className="flex flex-row">
            ...
            <div className="flex flex-col justify-center md:mt-8 md:ml-4 md:bg-slate-100 md:h-20 md:w-60 md:text-center md:rounded-lg">
              <h5 className="text-xl font-Montserrat font-medium">Felipe Ramirez</h5>
              <p className="font-light text-sm font-Montserrat text-[#B0BEC5]">felipe.ramirez@gmail.com</p>
            </div>
          </div>
          <button className="mr-4 md:flex md:mt-4 ml-8 mb-6 ">
            <Image className="mt-4 md:mt-0" src={goOut} width={30} height={30} />
            <p className="hidden md:inline-block md:font-medium md:text-xl md:font-Montserrat md:ml-2">Cerrar sesión</p>
          </button>
        </div>
      </div>
  );
