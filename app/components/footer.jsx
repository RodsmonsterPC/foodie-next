    ...
    <footer className="bg-[#FAFFC0] w-full h-[50rem] md:h-[23.8rem]">
      <div className="md:flex">
        <div className="flex md:flex md:flex-col md:mt-[5.6rem] md:ml-[3.5rem] ">
          <img
            className="mt-12 ml-4 w-40 h-16 md:ml-0 md:mt-0"
            src="/logo.svg"
            alt="logo"
          />
        ...
        <div className="mt-[1.75rem] ml-4 md:ml-32 md:mt-[5.6rem]">
          ...
          <div className="flex items-center mt-4">
            ...
            <p className="ml-[0.75rem] font-medium text-base text-[#455A64]">
              (MEX) +52 1564 2789
            </p>
          </div>
          <div className="flex items-center mt-4">
        ...
        <div className="mt-[1.8rem] ml-4 md:ml-[13.6rem] md:mt-[5.6rem]">
          ...
          <p className="font-medium text-base text-[#455A64] mt-4">
        ...
        <div className="flex flex-col mt-8 md:ml-52 md:mt-[5.6rem]">
          <h5 className="font-semibold text-xl text-[#263238] mx-auto">
            ¡Únete a Foodie
          </h5>
          <button className="mt-4 w-[18.7rem] h-12 text-lg bg-button-color text-white rounded-full mx-auto">
            ¡Regístrate!
          </button>
        </div>
      </div>
      <div className="mt-8 md:mt-24">
        <p className="font-medium text-base text-[#455A64] text-center ">
          © 2023 Copyright. Todos los derechos reservados por Foodie.
        </p>
      </div>
    </footer>
  );
